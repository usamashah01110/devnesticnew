...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admin/dashboardAssets/vendors/codemirror/codemirror.css')}}" />
  <link rel="stylesheet" href="{{asset('admin/dashboardAssets/vendors/codemirror/ambiance.css')}}" />
  ...
  <link rel="stylesheet" href=".{{asset('admin/dashboardAssets/vendors/pwstabs/jquery.pwstabs.min.css')}}">
  <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700" rel="stylesheet">
  <link rel="shortcut icon" href="{{asset('admin/dashboardAssets/images/favicon.png')}}" />
  <link rel="stylesheet" href="{{asset('docs/style.css')}}">
</head>
...
<body>
  <div class="container-fluid documentation">
      ...
      <div class="col-md-3 col-xl-2 left-sidebar">
        <div class="logo-wrapper">
          <a href="{{ route('dashboard.index') }}">
            <img src="{{asset('admin/dashboardAssets/images/logo.svg')}}" alt="logo">
          </a>
        </div>
        ...
        <a class="d-block mt-4 text-muted" target="_blank" href="{{ route('dashboard.index') }}">Go to Home</a>
      </div>
    ...
    <script src="{{asset('docs/script.js')}}"></script>
</body>
