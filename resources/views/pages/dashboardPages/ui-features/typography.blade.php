            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description"> Add tags <code>&lt;h1&gt;</code> to <code>&lt;h6&gt;</code> or
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    unknown printer took a galley not only five centuries, </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description"> Wrap content inside<code>&lt;blockquote
                                class="blockquote"&gt;</code>
                        </p>
            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description"> Use class <code>.text-primary</code>, <code>.text-secondary</code>
                            etc. for text in theme colors </p>
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p> It is a long
                            <mark class="bg-warning text-white">established</mark>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-lowercase"> lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-uppercase"> lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut
                            labore et dolore magna aliqua. </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted"> lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut labore
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            <del> lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut labore et dolore
                                magna aliqua.
                            </del>
                        </p>
                    </div>
                    <div class="card-body">
                        ...
                        <p class="text-capitalize"> lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut
                            labore et dolore magna aliqua. </p>
                    </div>
                </div>
            </div>
