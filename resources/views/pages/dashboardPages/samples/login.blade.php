            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="{{asset('admin/dashboardAssets/images/logo.svg')}}">
                </div>
                ...
                <form class="pt-3">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="{{ route('dashboard.register') }}" class="text-primary">Create</a>
                  </div>
                </form>
              </div>
            </div>
