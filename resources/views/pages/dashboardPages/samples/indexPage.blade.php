        ...
        <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                    <div class="card-body">
                        <img src="{{asset('admin/dashboardAssets/images/dashboard/circle.svg')}}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('admin/dashboardAssets/images/faces/face1.jpg')}}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('admin/dashboardAssets/images/faces/face2.jpg')}}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('admin/dashboardAssets/images/faces/face3.jpg')}}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('admin/dashboardAssets/images/faces/face4.jpg')}}"
