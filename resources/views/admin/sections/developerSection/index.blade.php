    ...
    <div class="container">
        <div class="container">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('section.create.view', ['section'=> 'developer']) }}">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        @foreach ($records as $sec)
                            ...
                            <tr>
                                ...
                                <td class="text-truncate" style="max-width:90px;">
                                    <a href="{{ route('section.delete',['section'=>'developer', 'id'=> $sec->id]) }}">
                                        <button class="badge badge-danger">Delete</button>
                                    </a>
                                    <br>
                                    <br>

                                    <a href="{{ route('section.edit.view',['section'=>'developer', 'id'=> $sec->id]) }}">
