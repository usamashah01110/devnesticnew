...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <hr/>
            <form action="{{ route('section.update', ['section' => 'hero']) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="btn_one_text" value="{{ $record->btn_one_text }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">Years</label>
                    <input type="text" class="form-control" name="years" value="{{ $record->years }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">Clients</label>
                    <input type="text" class="form-control" name="clients" value="{{ $record->clients }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">Success Rate</label>
                    <input type="text" class="form-control" name="success_rate" value="{{ $record->success_rate }}">
                </div>
                        ...
                        @if($record->image_path)
                            <div class="image-container">
                                <img id="previewImage" class="preview-image"
                                     src="{{ asset('storage/'.$record->image_path) }}" alt="Current Image">
                                <div>
