...
@section('content')
    <div class="container">
        <div class="container">
            <h1 class="text-center">Update Contact Section</h1>
            <hr/>
            <form action="{{ route('section.update', ['section' => 'contact','id'=>$record->id]) }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="city" id="city" class="form-control" value="{{ $record->city }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="contact_two" id="contact_two" class="form-control"
                           value="{{ $record->contact_two }}">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="text" name="email" id="email" class="form-control" value="{{ $record->email }}">
                </div>
