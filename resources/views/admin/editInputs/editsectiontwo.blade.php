...
<div class="container">
    ...
    <form action="{{ route('section.two.update', $sectionTwo->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <!-- Text fields -->
        <div class="mb-3">
            <label class="form-label">Short About Us</label>
            <input type="text" class="form-control" name="short_about_us" value="{{ $sectionTwo->short_about_us }}">
        </div>

        <div class="mb-3">
            <label class="form-label">Heading One</label>
            <input type="text" class="form-control" name="heading_one" value="{{ $sectionTwo->heading_one }}">
        </div>

        <div class="mb-3">
            <label class="form-label">Paragraph</label>
            <textarea class="form-control" name="paragraph" rows="3">{{ $sectionTwo->paragraph }}</textarea>
        </div>

        <div class="mb-3">
            <label class="form-label">Experience</label>
            <input type="text" class="form-control" name="experiance" value="{{ $sectionTwo->experiance }}">
        </div>

        <div class="mb-3">
            <label class="form-label">CEO & Founder Name</label>
            <input type="text" class="form-control" name="ceo_founder_name" value="{{ $sectionTwo->ceo_founder_name }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <div id="ceoImagePreview" class="image-preview">
                @if($sectionTwo->ceo_founder_img)
                    <div>
                        <img class="preview-image" src="{{ asset('storage/'.$sectionTwo->ceo_founder_img) }}">
        ...
        <div class="mb-3">
            ...
            <div id="largeImagePreview" class="image-preview">
                @if($sectionTwo->large_img)
                    <div>
                        <img class="preview-image" src="{{ asset('storage/'.$sectionTwo->large_img) }}">
                        <button type="button" class="btn btn-sm btn-danger remove-btn">Remove Image</button>
                    </div>
                @else
                    <div class="upload-placeholder">
        ...
        <div class="mb-3">
            ...
            <div id="smallImagePreview" class="image-preview">
                @if($sectionTwo->small_img)
                    <div>
                        <img class="preview-image" src="{{ asset('storage/'.$sectionTwo->small_img) }}">
                        <button type="button" class="btn btn-sm btn-danger remove-btn">Remove Image</button>
                    </div>
                @else
                    <div class="upload-placeholder">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="contact" value="{{ $sectionTwo->contact }}">
        </div>
