...
<div class="container">
    <div class="container">
        ...
        @endif
        <hr/>
        <form action="{{ route('section.three.update', $sectionThree->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div id="logoPreviewContainer" class="image-preview">
                    @if($sectionThree->logo)
                        <div class="image-container">
                            <img id="previewLogo" class="preview-image" src="{{ asset('storage/'.$sectionThree->logo) }}" alt="Current Logo">
                            <div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="title" value="{{ $sectionThree->title }}">
            </div>

            <!-- Service Description -->
            <div class="mb-3">
                <label class="form-label">Description</label>
                <input type="text" class="form-control" name="description" value="{{ $sectionThree->description }}">
            </div>

            <!-- Link -->
            <div class="mb-3">
                <label class="form-label">Service Link</label>
                <input type="text" class="form-control" name="link" value="{{ $sectionThree->link }}">
            </div>
