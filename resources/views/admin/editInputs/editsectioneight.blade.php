...
<div class="container">
    <div class="container">
        ...
        <hr />
        <form action="{{ route('section.eight.update', $sectionEight->id) }}" method="post" enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label for="developer_id" class="form-label">Developer ID</label>
                <input type="text" name="developer_id" id="developer_id" class="form-control" value="{{ $sectionEight->developer_id }}">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" id="description" name="description" class="form-control" value="{{ $sectionEight->description }}">
            </div>
