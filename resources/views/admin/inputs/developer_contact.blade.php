...
@section('content')
    ...
    <div class="container">
        <div class="container">
            <h1 class="text-center">Create Developer Contact</h1>
            <hr/>
            <form action="{{ route('developer.contact.store') }}" method="post" enctype="multipart/form-data">
                @csrf
